      ...
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-7 w-auto" :src="logoSvg" alt="" />
          </a>
        </div>
      ...
      <Dialog class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
        ...
        <DialogPanel
          ...
          <div class="flex items-center justify-between">
            <a href="#" class="-m-1.5 p-1.5">
              <span class="sr-only">Vinoteqa</span>
              <img class="h-8 w-auto" :src="logoSvg" alt="" />
            </a>
        ...
        <div
          ...
          <div class="mt-10 sm:mt-32 lg:mt-16">
            <a href="#" class="inline-flex space-x-6">
              <span
                class="rounded-full bg-vinoteqa/5 px-3 py-1 text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-vinoteqa/30">
                {{ titleLabel }}
              </span>
            </a>
          ...
          <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
            ...
            <div class="mt-10 flex items-center gap-x-6">
              ...
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900">{{ secondaryButtonLabel }}<span
