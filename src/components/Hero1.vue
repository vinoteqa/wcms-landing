...
<template>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
        <img :src="heroBg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#"
                            class="rounded-md bg-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">{{
            primaryButtonLabel }}</a>
                        <a href="#" class="text-sm font-semibold leading-6 text-white">{{ secondaryButtonLabel }}<span
