<template>
    <div class="page bg-white">
        <main>
            <div class="top-ct">
                <Header :logoSrc="logoSrc" logoAlt="Logo Vinoteqa Blog" logoSize="11" :navigation="navigation" :actionButtonLabel="actionButtonLabel"
                    :actionButtonLink="actionButtonLink" />
            </div>
            <div class="blog-content py-32 px-8 mx-auto max-w-7xl">
                <a :href="localePath('/blog')" class="text-sm font-semibold leading-6 text-black/95 hover:text-black">←
                    {{ $t('common.goBack') }}</a>
                <ContentDoc>
                    <template v-slot="{ doc }">
                        <Article :doc="doc" />
